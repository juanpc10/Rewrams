...
export declare const gapInsideRow: (value: any) => {
    pl: any;
};
export declare const gapInsideColumn: (value: any) => {
    pt: any;
};
export declare const useGapCtx: () => Gap;
export declare const useGapProps: (itemIndex: number) => {
    pl: any;
} | {
    pt: any;
};
...
export declare type Gap = number | string | 'inherit' | Partial<Record<'xs' | 'sm' | 'md' | 'lg' | 'xl', string | number>>;
