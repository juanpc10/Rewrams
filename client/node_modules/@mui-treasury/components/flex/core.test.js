...
describe('Flex', function () {
  describe('Row', function () {
    ...
    it('[direction: row] children has correct gap', function () {
      (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_Row["default"], {
        gap: 2
  ...
  describe('Nested', function () {
    ...
    it('Nested has correct gap', function () {
      (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_Row["default"], {
        gap: 2
      }, /*#__PURE__*/_react["default"].createElement(_Item["default"], null, "item1"), /*#__PURE__*/_react["default"].createElement(_Row["default"], {
        gap: 1,
      ...
      expect(_react2.screen.getByTestId('nested-row')).not.toHaveStyle('padding: 8px 8px 8px 16px');
      expect(_react2.screen.getByTestId('nested-row')).toHaveStyle('padding-left: 16px');
      expect(_react2.screen.getByTestId('nested-column')).not.toHaveStyle('padding: 24px 24px 24px 16px');
      expect(_react2.screen.getByTestId('nested-column')).toHaveStyle('padding-left: 16px');
    });
  });
