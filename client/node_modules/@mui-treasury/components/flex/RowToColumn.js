...
var styles = function styles(theme) {
  ...
  return {
    root: function root(_ref) {
      ...
      return _ref3 = {
        display: 'flex'
      }, _defineProperty(_ref3, breakpoints.up(at), _extends(_extends({}, columnStyle), {}, {
        flexDirection: columnReversed ? 'column-reverse' : 'column'
      }, (0, _utils.gapToCss)(theme)(gap, function (value) {
        return _defineProperty({}, "& > *:not(:".concat(columnReversed ? 'last' : 'first', "-child)"), {
          paddingTop: value
        });
      }))), _defineProperty(_ref3, (0, _utils.getLowerMediaQuery)(theme, at), _extends(_extends({
        alignItems: 'center'
      }, rowStyle), (0, _utils.gapToCss)(theme)(gap, function (value) {
        return {
          '& > *:not(:first-child)': {
            paddingLeft: value
          }
...
var RowToColumn = function RowToColumn(_ref4) {
  var className = _ref4.className,
      children = _ref4.children,
      gap = _ref4.gap,
      at = _ref4.at,
      columnReversed = _ref4.columnReversed,
      columnStyle = _ref4.columnStyle,
      rowStyle = _ref4.rowStyle,
      props = _objectWithoutProperties(_ref4, ["className", "children", "gap", "at", "columnReversed", "columnStyle", "rowStyle"]);
  ...
  }, itemProps, props), /*#__PURE__*/_react["default"].createElement(_core.Provider, {
